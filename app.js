  ...
  function openPlant(
    ...
    els.dialogContent.innerHTML=`
      ...
      <section class="detail-section">
        ...
        <h3>
          Photo and external plant resources
        </h3>
        ...
        ${
          refs
            ? `<p class="external-links compact-links">${refs}</p>`
            : ""
        }
      ...
      <section class="detail-section">
        ...
        <h3>
          Plant communities, distribution, and elevation
        </h3>
      ...
      <section class="detail-section">
        ...
        <h3>
          Restoration benefits and concerns
        </h3>
      ...
      <section class="detail-section">
        ...
        <h3>
          Source soil-texture fields
        </h3>

        <table class="match-table compact-table">
          <tbody>
            ${rawSoilRows(p)}
          </tbody>
        </table>
      ...
      <section class="detail-section">
        ...
        <h3>
          Soil chemistry, site tolerances, and ecosystem-service traits
        </h3>
      ...
      <section class="detail-section">
        ...
        <h3>
          Germination, establishment, and performance
        </h3>
        ...
        ${detailGrid([
          ...
          detailLine(
            "Germination overall",
            perf.germinationOverall
          ),

          detailLine(
            "Germination rate",
            perf.germinationRate
          ),

          detailLine(
            "Germination requirements",
            perf.germinationRequirements
          ),
      ...
      <section class="detail-section">
        ...
        <p class="detail-note">
          Internal master-table fields not intended
          for public display are not included in this
          browser dataset.
        </p>
